    ...
    <section className="relative px-4 py-24 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="font-body text-lg text-ink/85 mt-6 max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-6">
          {wedding.events.map((event, i) => (
            <motion.button
              ...
              className="group relative rounded-2xl bg-gradient-card border border-gold-dark/30 p-6 sm:p-8 shadow-soft transition-all duration-500 hover:shadow-envelope hover:border-gold-dark/60"
            >
              {/* corner ornaments */}
              ...
              <h3 className="font-script text-3xl sm:text-4xl text-ink">{event.name}</h3>
        ...
        >
          ...
          <p className="mt-4 font-body italic text-ink/80">
            "And so the forever begins…"
          </p>
          <p className="mt-6 font-display tracking-[0.4em] text-xs text-ink font-semibold">
            {wedding.hashtag}
          </p>
        </motion.div>
      </div>
        ...
        {active && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-md rounded-2xl bg-gradient-card border-2 border-gold-dark/50 p-8 shadow-envelope"
            >
              <button
                onClick={() => setActive(null)}
                aria-label="Close"
                className="absolute top-3 right-3 w-9 h-9 rounded-full bg-ink/10 hover:bg-ink/20 text-ink flex items-center justify-center transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
              ...
              <div className="text-center">
                ...
                <p className="font-body italic text-ink/80 px-2 mb-6">{active.blurb}</p>

                <div className="space-y-3 text-left max-w-xs mx-auto">
                  <div className="flex items-start gap-3">
                    <Calendar className="w-5 h-5 text-gold-dark mt-0.5 shrink-0" />
                    <div>
                      <p className="font-display tracking-widest text-[10px] text-ink/60">DATE</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-display tracking-widest text-[10px] text-ink/60">TIME</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-display tracking-widest text-[10px] text-ink/60">VENUE</p>
                ...
                <a
                  ...
                  className="mt-7 inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-terracotta text-primary-foreground font-display text-xs tracking-[0.25em] shadow-gold transition-all duration-300 hover:scale-105 hover:animate-glow-pulse"
                >
